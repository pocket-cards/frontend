  ...
  render() {
    ...
    return (
      <Grid container alignItems="center" justify="flex-start" direction="column" className={classes.root}>
        <input type="file" id="upload" accept="image/*" style={{ display: 'none' }} onChange={this.handleFileChange} />
        {(() => {
          ...
          return (
            <React.Fragment>
              ...
              <Grid item className={classes.item}>
                <Button variant="contained" color="primary" className={classes.button} onClick={this.startCamera}>
                  Take Photo
                </Button>
              </Grid>
              <Grid item className={classes.item}>
                <Button variant="contained" color="primary" className={classes.button} onClick={this.handleUpload}>
                  Upload Photo
                </Button>
              </Grid>
            </React.Fragment>
        ...
        <WebCamera onAir={onAir} takePhoto={this.handleCamera} afterStopCamera={this.afterStopCamera} />
      </Grid>
    );
  }
}
