...
class ClCamera extends Component {
  ...
  render() {
    const imageDisplay = this.state.capturedImage ? <img src={this.state.capturedImage} alt="captured" width="350" /> : <span />;
  ...
  uploadImage = () => {
    if (this.props.offline) {
      ...
      // axios
      //   .post(`https://api.cloudinary.com/v1_1/${process.env.REACT_APP_CLOUD_NAME}/image/upload`, {
