...
/** 画像アップロード */
export type UploadImageThunkAction = ThunkAction<Promise<void>, IState, APIClass, Action<A001Actions>>;
export type UploadImageAction = ActionFunction2<string, History<any>, UploadImageThunkAction>;
/** 単語削除 */
export type RemoveWordThunkAction = ThunkAction<void, IState, APIClass, Action<A002Actions>>;
export type RemoveWordAction = ActionFunction1<string, RemoveWordThunkAction>;
/** 単語登録 */
export type RegistWordsThunkAction = ThunkAction<Promise<void>, IState, APIClass, Action<A003Actions>>;
export type RegistWordsAction = ActionFunction2<string[], History<any>, RegistWordsThunkAction>;
/** 単語登録 */
export type ClearThunkAction = ThunkAction<void, IState, APIClass, Action<A004Actions>>;
...
export type A001RequestAction = ThunkAction<A001RequestBaseAction, IState, APIClass, A001RequestBaseAction>;
export type A001SuccessAction = ActionFunction1<D001Response, ThunkAction<A001SuccessBaseAction, IState, APIClass, A001SuccessBaseAction>>;
export type A001FailureAction = ActionFunction1<Error, ThunkAction<A001FailureBaseAction, IState, APIClass, A001FailureBaseAction>>;
...
export type A002RequestAction = ThunkAction<A002RequestBaseAction, IState, APIClass, A002RequestBaseAction>;
export type A002SuccessAction = ActionFunction1<string, ThunkAction<A002SuccessBaseAction, IState, APIClass, A002SuccessBaseAction>>;
export type A002FailureAction = ActionFunction1<Error, ThunkAction<A002FailureBaseAction, IState, APIClass, A002FailureBaseAction>>;
...
export type A003RequestAction = ThunkAction<A003RequestBaseAction, IState, APIClass, A003RequestBaseAction>;
export type A003SuccessAction = ActionFunction0<ThunkAction<A003SuccessBaseAction, IState, APIClass, A003SuccessBaseAction>>;
export type A003FailureAction = ActionFunction1<Error, ThunkAction<A003FailureBaseAction, IState, APIClass, A003FailureBaseAction>>;
...
export type A004RequestAction = ThunkAction<A004RequestBaseAction, IState, APIClass, A004RequestBaseAction>;
export type A004SuccessAction = ThunkAction<A004SuccessBaseAction, IState, APIClass, A004SuccessBaseAction>;
export type A004FailureAction = ActionFunction1<Error, ThunkAction<A004FailureBaseAction, IState, APIClass, A004FailureBaseAction>>;
