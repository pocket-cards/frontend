...
import { createAction, ActionFunction0, Action, ActionFunction1, ActionFunction2 } from 'redux-actions';
...
export type GroupListThunkAction = ThunkAction<void, IState, APIClass, Action<GroupListPayload>>;
