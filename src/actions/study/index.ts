...
export type StartNewAction = ActionFunction1<History<any>, ThunkAction<Promise<void>, IState, APIClass, Action<B001Actions>>>;
// export type NextAction = ThunkAction<B002Actions, any, void, B002Actions>;
// export type RetryAction = ThunkAction<B003Actions, any, void, B003Actions>;
export type AnswerAction = ActionFunction2<string, boolean, ThunkAction<Promise<void>, IState, APIClass, Action<B004Actions>>>;
// export type StartNewTestAction = ActionCreator<ThunkAction<Promise<void>, any, void, Action<B005Actions>>>;
export type StartReviewAction = ActionFunction1<History<any>, ThunkAction<Promise<void>, IState, APIClass, Action<B006Actions>>>;
export type StartTestAction = ActionFunction1<History<any>, ThunkAction<Promise<void>, IState, APIClass, Action<B007Actions>>>;
...
export type B001RequestAction = ThunkAction<B001RequestBaseAction, IState, APIClass, B001RequestBaseAction>;
export type B001SuccessAction = ActionFunction1<WordInfo[], ThunkAction<B001SuccessBaseAction, IState, APIClass, B001SuccessBaseAction>>;
export type B001FailureAction = ActionFunction1<Error, ThunkAction<B001FailureBaseAction, IState, APIClass, B001FailureBaseAction>>;
...
export type B004RequestAction = ThunkAction<B004RequestBaseAction, IState, APIClass, B004RequestBaseAction>;
export type B004SuccessAction = ActionFunction1<boolean, ThunkAction<B004SuccessBaseAction, IState, APIClass, B004SuccessBaseAction>>;
export type B004FailureAction = ActionFunction1<Error, ThunkAction<B004FailureBaseAction, IState, APIClass, B004FailureBaseAction>>;
...
// export type B005RequestAction = ThunkAction<B005RequestBaseAction, void, void, B005RequestBaseAction>;
// export type B005SuccessAction = ActionCreator<ThunkAction<B005SuccessBaseAction, void, void, B005SuccessBaseAction>>;
// export type B005FailureAction = ActionCreator<ThunkAction<B005FailureBaseAction, void, void, B005FailureBaseAction>>;
...
export type B006RequestAction = ThunkAction<B006RequestBaseAction, IState, APIClass, B006RequestBaseAction>;
export type B006SuccessAction = ActionFunction1<WordInfo[], ThunkAction<B006SuccessBaseAction, IState, APIClass, B006SuccessBaseAction>>;
export type B006FailureAction = ActionFunction1<Error, ThunkAction<B006FailureBaseAction, IState, APIClass, B006FailureBaseAction>>;
...
export type B007RequestAction = ThunkAction<B007RequestBaseAction, IState, APIClass, B007RequestBaseAction>;
export type B007SuccessAction = ActionFunction1<WordInfo[], ThunkAction<B007SuccessBaseAction, IState, APIClass, B007SuccessBaseAction>>;
export type B007FailureAction = ActionFunction1<Error, ThunkAction<B007FailureBaseAction, IState, APIClass, B007FailureBaseAction>>;
