...
export const success: App02SuccessAction = createAction(APP_02_SUCCESS, (visible: boolean) => ({ visible }));
export const failure: App02FailureAction = createAction(APP_02_FAILURE, (error: Error) => ({ error }));
